    ...
    <div className="section section-static contact" id="section5">
      {!formSubmitted && (
        <div className="row">
          ...
          <div className="col-sm-6">
              <form method="post" encType="text/plain" action="mailto:nikki.everett@outlook.com" className="section__form" onSubmit={() => setFormSubmitted(true)}>
                <div className="row">
                  <div className="col-sm-6">
      ...
      {formSubmitted && (
        <div className="thankyou">
          <h2 class="section__title">Thanks!</h2>
          <p class="section__text">I'll be in touch</p>
        </div>
      )}
    </div>
  )
